...
images = ["/home/clover/Desktop/Charuco/20211029_182538.jpg"]

import os



directory = os.fsencode("/home/clover/Desktop/Charuco")
...
for file in os.listdir(directory):
     ...
     images.append("/home/clover/Desktop/Charuco/" + str(filename))
...
projection_matrix = __compute_proj_mat(cameraMatrix, rvecs, tvecs)

print("cameraMatrix: {}".format(cameraMatrix))

print("distCoeffs: {}".format(distCoeffs))
...
with open(fname, "w") as f:
    ...
    f.write("[ {0}".format(distCoeffs[0][0]))

    for i in range(1,len(distCoeffs[0])):

        f.write(", {0}".format(distCoeffs[0][i]))
...
print('Calibration successful. Calibration file used: {}'.format(fname))
